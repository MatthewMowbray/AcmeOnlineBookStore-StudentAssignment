             ...
             <table width="100%" border="1" cellspacing="0" cellpadding="3" height="98">
                ...
                <c:choose>
                    <c:when test="${not empty s_cart}"> 
                        <c:forEach var="item" items="${s_cart}" >
                            ...
                            <c:set var="totalCostOfOrder" scope="application" value="${totalCostOfOrder + cost}"/>       
                <tr bgcolor="#F0F0F0"> 
                ...
                <td width="34%" height="5"><c:out value="${title}"/></td>
                    ...
                    <td width="20%" height="5"> 
                        <div align="right"><c:out value="${cost}"/></div>
                    </td>
                ...
                <tr bgcolor="#E4E4E4"> 
                    ...
                    <td width="20%" height="2" bordercolor="#CCCCCC"> 
                        <div align="right"><b><fmt:formatNumber value="${totalCostOfOrder}" type="currency"/></b></div>
                    </td>
